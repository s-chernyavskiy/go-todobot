...
const (
	TelegramService_GetUpdates_FullMethodName  = "/todobot.TelegramService/GetUpdates"
	TelegramService_SendMessage_FullMethodName = "/todobot.TelegramService/SendMessage"
)
...
func (c *telegramServiceClient) GetUpdates(ctx context.Context, in *GetUpdatesRequest, opts ...grpc.CallOption) (*GetUpdatesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUpdatesResponse)
	err := c.cc.Invoke(ctx, TelegramService_GetUpdates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTelegramServiceServer) GetUpdates(context.Context, *GetUpdatesRequest) (*GetUpdatesResponse, error) {
...
func _TelegramService_GetUpdates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelegramService_GetUpdates_FullMethodName,
	}
...
var TelegramService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "todobot.TelegramService",
	...
	Metadata: "proto/todobot/todobot.proto",
}
